...
namespace LS.Client
{
    ...
    class LsConnectionListener : IConnectionListener
    {
        ...
        private Label lblConnecionStatus;

        public LsConnectionListener() { }

        public LsConnectionListener(Label lblConnecionStatus)
        {
            this.lblConnecionStatus = lblConnecionStatus;
        }
        ...
        {
            lblConnecionStatus.Text = "Connecion Failed";
